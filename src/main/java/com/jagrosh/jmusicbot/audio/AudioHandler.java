...
public class AudioHandler extends AudioEventAdapter implements AudioSendHandler {
    ...
    public void onTrackException(AudioPlayer player, AudioTrack track, FriendlyException exception) {
        LoggerFactory.getLogger("AudioHandler").error("Track " + track.getIdentifier() + " has failed to play",
                exception);
    }
    ...
    public MessageCreateData getNowPlaying(JDA jda) {
        if (isMusicPlaying(jda)) {
            ...
            mb.addContent(FormatUtil.filter(manager.getBot().getConfig().getSuccess() + " **Now Playing in "
